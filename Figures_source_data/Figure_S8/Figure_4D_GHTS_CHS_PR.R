...
df_violin_CHS <- read.csv("~/Desktop/MEX_trees/df_violin_GHTS_CHS_pr_15022024.csv")
...
Cairo(file='Figure_4D_GHTS_to_CHS_PR_15022024.pdf', type="pdf", width=200, height=200, units="mm")
c
dev.off()
