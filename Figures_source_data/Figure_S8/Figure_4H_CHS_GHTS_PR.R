...
df_violin_CHS <- read.csv("~/Desktop/MEX_trees/df_violin_CHS_GHTS_pr_15022024.csv")
...
Cairo(file='Figure_4H_CHS_to_GHTS_PR_15022024.pdf', type="pdf", width=200, height=200, units="mm")
c
dev.off()
